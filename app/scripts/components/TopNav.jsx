        ...
        <div className="tabs">
          <ul>
            <li className={this.props.selectedSection === 0 ? 'is-active' : ''} onClick={(e) => {this.navClick(e)}}>
              <a><span className="icon is-small"><i className="fa fa-image"></i></span>Refresh Contents</a>
            </li>
            <li className={this.props.selectedSection === 1 ? 'is-active' : ''} onClick={(e) => {this.navClick(e)}}>
              <a><span className="icon is-small"><i className="fa fa-film"></i></span>Flagship Guide</a>
            </li>
            <li className={this.props.selectedSection === 2 ? 'is-active' : ''} onClick={(e) => {this.navClick(e)}}>
              <a><span className="icon is-small"><i className="fa fa-book"></i></span>Documents</a>
            </li>
